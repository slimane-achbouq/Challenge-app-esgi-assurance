            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                    ...
                    <div ref="dropdown">
                      ...
                      <div class="py-2 px-3 border-t border-slate-200 bg-slate-50">
                        <ul class="flex items-center justify-between">
                          <li>
                            <button class="btn-xs bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600"  @click="clearFilters">Clear</button>
                          </li>
                          <li>
              ...
              <div class="relative">
                  ...
                  <transition
                    ...
                    leave-to-class="opacity-0"
                  >
                    <div v-show="dropdownOpen1" class="z-10 absolute top-full right-0 w-full bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
                      <div
                        ref="dropdown"
                      ...
                      >
                        ...
                        >
                          <svg class="shrink-0 mr-2 fill-current text-indigo-500" :class="option.id !== selected1 && 'invisible'" width="12" height="9" viewBox="0 0 12 9">
