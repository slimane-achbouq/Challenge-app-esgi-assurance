            ...
            <div class=" lg:mx-10">
              ...
              <div class="mb-6 lg:mb-0">
                <header class="mb-6 flex w-full justify-between">
                  <!-- Title -->
                  <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2"><i class="fas fa-file-contract"></i>
                    Contract Detail ✨ </h1>
                  <div>

                    <button class="btn border-slate-200 hover:border-slate-300 text-slate-600 mr-2"
                            @click="modalOpen=true" v-if="role==='Admin'">
                    ...
                    <button class="btn border-slate-200 hover:border-slate-300 text-rose-500"
                            @click="modaDeletelOpen=true" v-if="role==='Admin'">
                  ...
                  <div
                    ...
                    <header class="pr-10 pl-5 py-4 border-b border-slate-100 flex items-center justify-between">
                      <h2 class="font-semibold text-slate-800"><i class="fas fa-file-contract"></i> Contract
                        informations</h2>
                      <i class="far fa-edit cursor-pointer" @click="modalOpen=true" v-if="role==='Admin'"></i>
                    </header>
          ...
          <div>
                  ...
                  <div class="space-y-6">
                    ...
                    <div class="h-full px-5 py-2" v-if="user">
                      ...
                      <div class=" justify-center">
                        <div class="text-xs text-slate-500 font-semibold uppercase mb-3"><i class="fas fa-user"></i>
                          Beneficiary
                        </div>
              ...
              <div class="px-5 py-4">
                <div class="space-y-3 ">
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-1">
                      <label class="block text-sm font-medium mb-1" for="startingDate">Coverage End Date <span
                          class="text-rose-500">*</span><br></label>
                      <input type="date" class="form-input w-full" id="startingDate" name="startingDate"
            ...
            <ModalBasic id="danger-modal" :modalOpen="modaDeletelOpen">
              ...
              <div class="flex flex-wrap justify-end space-x-2 m-6">
                ...
                <button class="btn-sm bg-rose-500 hover:bg-rose-600 text-white" @click="deleteItem">Yes, Delete it
                </button>
              </div>
            </ModalBasic>
          </div>
...
export default {
  ...
  methods: {
    ...
    async deleteItem() {
      ...
      try {
        const response = await axios.delete(`${import.meta.env.VITE_API_URL}/insurance/${this.contract['_id']}`, {
          headers: {
