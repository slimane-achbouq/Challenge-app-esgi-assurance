                    ...
                    <div class="px-10  divide-y divide-slate-100 space-y-3">
                      ...
                      <div>
                        <div class="flex justify-between text-sm m-3">
                          ...
                          <div class="  "><span
                              class=" bg-emerald-100 text-emerald-600 font-medium rounded-full text-center px-2.5 py-1">valid</span><span
                              class="bg-amber-100 text-amber-600 font-medium rounded-full text-center px-2.5 py-1">invalid</span>
                          </div>
                        </div>
                      </div>
