  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <Banner type="success" class="mb-4"  :open="true" v-if="caretCrise">
          ...
          <div class="px-4 sm:px-6 lg:px-8 py-8 lg:grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
            <div class="lg:max-w-[1240px] lg:mx-auto">
              ...
              <div class="mb-6 lg:mb-0">
                ...
                <header class="mb-6">
                  <!-- Title -->
                  <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2" >Contract subscription</h1>
                  <p></p>
                </header>
                ...
                <div>
                 ...
                 <div class="space-y-4">
                      ...
                      <div class="text-right">
                        ...
                        <button type=""  class="btn bg-indigo-500 border-slate-200 hover:border-slate-300 text-white">Submit</button>
        ...
        <ModalBlank id="success-modal" :modalOpen="false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <div class="text-sm mb-10">
                            <div class="space-y-2">
                              <p>The contract has been created successfully.you need to pay the first month and wait for admin to aprove it</p>
                            </div>
                          </div>
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" >Contract list</button>
                            <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Payment</button>
                          </div>
                        </div>
                      </div>
        </ModalBlank>
        ...
        <ModalBasic id="feedback-modal" :modalOpen="true" title="Choose your Plan">
                      ...
                      <div class="px-5 pt-4 pb-1">
                        <div class="text-sm">
                          <div class="mb-4">Available plans based on your vehicle informations:</div>
                          <!-- Options -->
                          <ul class="space-y-2 mb-4">
                            <li>
                              <button class="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-indigo-400 shadow-sm duration-150 ease-in-out">
                                <div class="flex items-center">
                                  <div class="radioButton1 border-2 border-indigo-500 rounded-full mr-3"></div>
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                      <span class="font-medium text-slate-800">Basic <span class="text-xs italic text-slate-500 align-top"></span></span>
                            ...
                            <li>
                              <button class="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                <div class="flex items-center">
                                  <div class="radioButton2 border-2 border-slate-300 rounded-full mr-3"></div>
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                            ...
                            <li>
                              <button class="w-full h-full text-left py-3 px-4 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                <div class="flex items-center">
                                  <div class="radioButton3 border-2 border-slate-300 rounded-full mr-3"></div>
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          ...
                          <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Confirm plan</button>
                        </div>
                      </div>
        </ModalBasic>
