  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <main>
        ...
        <Banner type="success" class="mb-4" :open="claimCreated" v-if="claimCreated">
            ...
            <div>
              ...
              <header class="mb-4">
                ...
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2"><i class="fas fa-file-signature"></i>
                  Claim Informations ✨</h1>
                <p>After creating your claim, the admin will review it before giving a decision.</p>
              </header>
                ...
                <form>
                  <div class="space-y-3">
                    ...
                    <div class="space-y-3">
                      ...
                      <label class="block text-sm font-medium mb-1" for="card-country">Your proof <span
                          class="text-rose-500">*</span></label>
                      ...
                      <div class="shadow-lg rounded-sm border px-5 py-4 bg-amber-10 border-amber-300"
                        ...
                        <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                          ...
                          <div class="flex items-start space-x-3 md:space-x-4">
                            ...
                            <div>
                              Proof image :
                              <div class="text-sm">{{ formData.proof.name }}</div>
                            </div>
                          </div>
                        ...
                        <label for="dropzone-file"
                          ...
                          <div
                            ...
                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                              <span class="font-semibold">Click to upload an image</span> or
                              drag and drop</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                              This action is required</p>
                          </div>
                      ...
                      <p class="text-xs mt-1 text-rose-500" v-if="errors">Proof
                        required</p>
                      ...
                      <div class="text-right">
                        ...
                        <button type="submit"
                                ...
                                @click.prevent="onCreatedClaim" v-if="!claimCreated">Submit
                        </button>
        ...
        <ModalBlank id="success-modal" :modalOpen="claimCreated" v-if="claimCreated">
          <div class="p-5 flex space-x-4">
            ...
            <div>
              <!-- Modal header -->
              <div class="mb-2">
                <div class="text-lg font-semibold text-slate-800">Claim created successfully</div>
              </div>
              <!-- Modal content -->
              <div class="text-sm mb-10">
                <div class="space-y-2">
                  <p>The claim has been created successfully.wait until the review by the admin</p>
                </div>
              </div>
              <!-- Modal footer -->
