  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <div class="flex flex-col col-span-full bg-white shadow-lg rounded-sm border border-slate-200 mx-8 my-3">
                <div class="px-5 py-2">
                      <div>
                        <div class="mb-2 "><i class="fas fa-file-contract"></i><strong class="text-1xl text-slate-800"> Quote inforamtions</strong> </div>
                      </div>
                  <div class="">
                    <!-- Left side -->
        ...
        <div class="px-4 sm:px-6 lg:px-8  w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              ...
              <header class="mb-4">
                <!-- Title -->
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2"><i class="fas fa-file-signature"></i> Contract Informations ✨</h1>
                <p>After creating your contract, the admin will check this inforamtions before validate your contract.</p>
              </header>
              ...
              <div>
                  <form>
                    <div class="space-y-3">
                      ...
                      <div class="flex items-center justify-center w-full"
                        ...
                        <div class="shadow-lg rounded-sm border px-5 py-4 bg-amber-10 border-amber-300" v-if="hideImageFieladresse">
                 ...
                 <div class="space-y-4">
                      ...
                      <label class="block text-sm font-medium mb-1" for="card-country">Proof of your adresse <span class="text-rose-500">*</span></label>
                      <div class="flex items-center justify-center w-full"
                        ...
                        <div class="shadow-lg rounded-sm border px-5 py-4 bg-amber-10 border-amber-300" v-if="hideImageFielddrivingLicense">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                <!-- Left side -->
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    <div class="w-9 h-9 shrink-0 mt-1">
                      ...
                      <div class="text-right">
                        ...
                        <button type=""  class="btn bg-indigo-500 border-slate-200 hover:border-slate-300 text-white" @click.prevent="onCreatedContract" v-if="!contractCreated">Submit</button>
            ...
            <div>
              <div class="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
                <div class="text-sm text-slate-800 font-semibold mb-3"><i class="fab fa-buffer"></i> Choose the plan : </div>
                <ul class="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4" v-if="prices">
                  <li>
                    <button  :class="{'border-2 border-indigo-400': selectedPlan === 'Basic', 'border border-slate-200 hover:border-slate-300': selectedPlan !== 'Basic'}" class="w-full h-full text-left py-3 px-4 rounded bg-white shadow-sm duration-150 ease-in-out" @click="price =Math.round(prices[0]) ; selectedPlan = 'Basic'">
                  ...
                  <li>
                    <button :class="{'border-2 border-indigo-400': selectedPlan === 'Standard', 'border border-slate-200 hover:border-slate-300': selectedPlan !== 'Standard'}" class="w-full h-full text-left py-3 px-4 rounded bg-white shadow-sm duration-150 ease-in-out" @click="price =Math.round(prices[1]) ;;selectedPlan = 'Standard'">
                      <div class="flex flex-wrap items-center justify-between mb-0.5">
                        <span class="font-semibold text-slate-800">Standard <span class="text-xs italic text-indigo-500 align-top">Best Value ✨</span></span>
                  ...
                  <li>
                    <button :class="{'border-2 border-indigo-400': selectedPlan === 'Premium', 'border border-slate-200 hover:border-slate-300': selectedPlan !== 'Premium'}" class="w-full h-full text-left py-3 px-4 rounded bg-white shadow-sm duration-150 ease-in-out" @click="price =Math.round(prices[2]) ;selectedPlan = 'Premium'">
                      <div class="flex flex-wrap items-center justify-between mb-0.5">
                ...
                <div class="text-xs text-slate-500 italic text-center">The available plans are based on your vehicle inforamtions<a class="underline hover:no-underline" href="#0"></a>.</div>
              </div>
            </div>
