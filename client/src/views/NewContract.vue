  ...
  <div class="flex h-screen overflow-hidden">
    ...
    >
      ...
      <main>
        ...
        <div class="flex items-center m-3" v-if="isLoaded">
          <div class="space-y-2">
            <p>

            <svg aria-hidden="true" class="w-9 h-20 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
