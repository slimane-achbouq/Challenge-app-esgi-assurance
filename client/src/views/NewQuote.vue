  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <main>
          ...
          <div class="px-4 sm:px-6 lg:px-8 py-8 lg:grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
            <div class="lg:max-w-[1240px] lg:mx-auto">
              ...
              <div class="mb-6 lg:mb-0">
                        ...
                        <ul class="relative flex justify-between w-full">
                          ...
                          <li>
                            <a
                                ...
                                :class="step.id >= 2 ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-500'"
                            >2</a
                            >
                          </li>
                          <li>
                            <a
                                class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold"
                                :class="step.id >= 3 ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-500'"
                            >3</a
                            >
                          </li>
                          <li>
                            <a
                                class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold"
                                :class="step.id >= 4 ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-500'"
                            >4</a
                            >
                          </li>
                        </ul>
                ...
                <header class="mb-6">
                  <!-- Title -->
                  <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2" v-if="step.id==1 || step.id==2"><i
                      class="fas fa-car"></i> Vehicle informations</h1>
                  <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2" v-if="step.id==3"><i
                      class="fas fa-file-signature"></i> Quote informations</h1>
                  <p></p>
                </header>
                  ...
                  <form>
                    <div class="space-y-4">
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==1">
                        ...
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-country">Vehicle Type <span
                        ...
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-name">Brand <span
                              class="text-rose-500">*</span></label>
                          <select id="brand" v-model="formData.brand" class="form-select w-full">
                            <option v-for="item in brands" :key="item.brand" :value="item.brand">{{
                                item.brand
                              }}
                            </option>
                          </select>
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==1">
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-address">Model <span
                              class="text-rose-500">*</span></label>
                        ...
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-city">Horse Power in HP<span
                              class="text-rose-500">*</span></label>
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==1">
                        ...
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="startingDate">License Obtained Date <span
                              class="text-rose-500">*</span><br></label>
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==2">
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-name">Annual Mileage (KM) <span
                              class="text-rose-500">*</span></label>
                        ...
                        <div class="flex-1" v-if="step.id==2">
                          <label class="block text-sm font-medium mb-1" for="startingDate">Vehicle Circulation Date
                            <span class="text-rose-500">*</span><br></label>
                          <input type="datetime-local" class="form-input w-full" id="startingDate" name="startingDate"
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==2">
                        ...
                        <div class="flex-1" v-if="step.id==2">
                          <label class="block text-sm font-medium mb-1" for="startingDate">Registration Card Date <span
                              class="text-rose-500">*</span><br></label>
                          <input type="datetime-local" class="form-input w-full" id="startingDate" name="startingDate"
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==2">
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-country">Purchase Mode <span
                              class="text-rose-500">*</span></label>
                        ...
                        <div class="flex-1" v-if="step.id==2">
                          <label class="block text-sm font-medium mb-1" for="card-name">Parking Postal Code <span
                              class="text-rose-500">*</span></label>
                          <input id="card-name" class="form-input w-full placeholder-slate-300" type="text"
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==3">
                        <div class="flex-1">
                          ...
                          <p class="text-xs mt-1 text-rose-500" v-if="errors.insurancetype">{{
                              errors.insurancetype
                            }}</p>
                        </div>
                        <div class="flex-1" v-if="step.id==3">
                          <label class="block text-sm font-medium mb-1" for="card-country">Coverage <span
                              class="text-rose-500">*</span></label>
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4" v-if="step.id==3">
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-address">Coverage Duration by months
                      ...
                      <p class="text-xs mt-1 text-rose-500" v-if="errors.filerequired && step.id ==1">Carte grise
                        required</p>
                      ...
                      <div class="text-right" v-if="!quoteCreated">
                        ...
                        <button type="" v-if="step.id==2 || step.id==3"
                                @click.prevent="prevStep({id: (step.id-1), label: 'Information',selectedTab: 'StepTwo' })"
                                class="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500">back
                        </button>
        ...
        <ModalBlank id="success-modal" :modalOpen="quoteCreated" v-if="quoteCreated">
