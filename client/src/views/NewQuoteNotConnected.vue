              ...
              <div class="mb-6 lg:mb-0">
                ...
                <header class="mb-6">
                  ...
                  <h1
                    ...
                    v-if="step.id == 4"
                  >
                    <i class="fas fa-file-signature"></i> Prices :
                  </h1>
                ...
                <div class="grid grid-cols-12 gap-6">
                  ...
                  >
                    <div
                      class=" bg-sky-500 absolute top-0 left-0 right-0 h-0.5 bg-sky-500"
                    ...
                    <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                      <header class="flex items-center mb-2">
                        <div
                          class="w-6 h-6 rounded-full shrink-0 bg-gradient-to-tr mr-3 from-indigo-500 to-indigo-300"
                      ...
                      <!-- CTA -->
                      <button
                        class="btn text-white w-full bg-sky-500"
                        
                        @click.prevent="quoteCreated=true"
                      >
                        Choose
                      </button>
                    </div>
    ...
    <div class="p-5 flex space-x-4">
      ...
      <div>
        ...
        <div class="text-sm mb-10">
          <div class="space-y-2">
            <p>
              Quote is created successfully , To continue you must connect / register
            </p>
          </div>
        </div>
        <!-- Modal footer -->
        ...
        this.formData.coverageDuration = isNaN(num)
          ...
          try {
            let response = await axios.post(
              `${import.meta.env.VITE_API_URL}/vehicles-with-quotes-nc`,
              this.formData
            );
    ...
    handleFile(event) {
      ...
      reader.onloadend = () => {
        this.base64File = reader.result;
         this.formData.carteGrise = this.base64File;
          console.log(this.formData.carteGrise)
