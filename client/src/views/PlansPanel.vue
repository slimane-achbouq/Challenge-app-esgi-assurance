    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
          ...
          <div class="text-sm">
            <p class="mb-2">Choose the plan that works best for you. Note that the payment becomes automatic monthly
              after first (and only) manual payment.</p>
          </div>
        </div>

        <!-- Pricing -->
        <div class="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto" v-if="prices">
          <!-- Pricing tabs -->
          <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-slate-200">
              ...
              <div class="relative absolute top-0 left-0 right-0 h-0.5 bg-sky-500" aria-hidden="true"></div>
              <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                <header class="flex items-center mb-2">
