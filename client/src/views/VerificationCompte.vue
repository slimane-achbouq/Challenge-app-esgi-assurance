<template>
    <main class="bg-white">
      ...
      <div class="relative flex">
        ...
        <div class="w-full md:w-1/2">
          <div class="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div class="max-w-sm mx-auto px-4 py-8">
              <SuccessMessage :message='successMessage' v-if="isSuccess"></SuccessMessage>
            </div>
        ...
        <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
          <img class="absolute top-1/4 -translate-x-1/4 ml-8 hidden lg:block" src="../images/verificationCompte.png" alt="Authentication" />
  ...
  export default {
      ...
      async created() {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/auth/verifyUser`, {
                headers: {
            ...
            const error = new Error(ex || 'Failed to verify profile. please return later !');
            Swal.fire({
                title: 'Sorry!',
                text:   ex.message,
                icon: 'error',
