  ...
  <main class="bg-white">
      ...
      <div class="grid md:grid-cols-2 gap-2 pt-3">
        <div class="max-w-sm mx-auto px-4 py-8">
          <form @submit.prevent="submitForm">
            <!-- Email adresse -->
            <div>
              <label class="block text-sm font-medium mb-1 pt-3" for="email"
            ...
            <!-- Object adresse -->
            <div>
              <label class="block text-sm font-medium mb-1 pt-3" for="text"
                >Object <span class="text-rose-500">*</span></label
              >
              <input
                id="object"
                v-model.trim="object"
    ...
    <section>
      <div class="px-4 mx-auto max-w-screen-xl text-center py-7 pt-4">
        <h4
          class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-gray-900 md:text-5xl lg:text-6xl"
        >
          <span
            class="text-transparent bg-clip-text bg-gradient-to-r to-indigo-600 from-indigo-300"
            >Azulance App</span
          >
          You can also contact us via the mobile application!
        </h4>
      </div>
      <div style="text-align: -webkit-center">
        <img
          class="object-contain h-60 w-76"
          src="../../images/iphone-application.png"
        />
      </div>
  ...
  methods: {
    async submitForm() {
      ...
      if (this.object.length < 3) {
        this.formValid = false;
        this.isLoading = false;
        this.errors.lastname = "Please enter a valid object";
        return;
      }
      ...
      if (this.message.length < 3) {
        this.formValid = false;
        this.isLoading = false;
        this.errors.lastname = "Please enter a wrie your message";
        return;
      }
      ...
      try {
        ...
        this.error =
          error.message || "Failed to send your message, please try later.";
        Swal.fire({
          title: "Sorry!",
          text: error.message,
          icon: "error",
