<template>
    <main class="bg-white">
        <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    ...
                    <li>
                        <a class="block py-2 pl-3 pr-4 text-indigo-500 bg-indigo-500 rounded md:bg-transparent md:text-indigo-500 md:p-0 md:dark:text-blue-500" aria-current="page">Services</a>
                    </li>
                    <li>
        ...
        <div class="space-y-8">
            ...
            <div>
                <div class="mb-5">
                    <div class="px-4 mx-auto max-w-screen-xl text-center py-7 pt-24">            
                        <h1 class="flex items-center text-slate-800 text-5xl font-extrabold dark:text-slate-800">Services<span class="bg-blue-100 text-blue-800 text-2xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">AZULANCE</span></h1>
                    </div>
                </div>
                <!-- Grid -->
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-7 pt-24">
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-gray-900 md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-indigo-600 from-indigo-300">Azulance App</span> You can also use our app!</h1>
        </div>
