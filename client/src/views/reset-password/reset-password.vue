    ...
    <main class="bg-white">
      ...
      <div class="relative flex" v-if="!isSuccess">
        ...
        <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
            <img class="object-cover object-center w-full h-full" src="../../images/reset-password-confirmation.jpg" width="760" height="1024" alt="Authentication" />
        </div>
...
import successMessageView from '../SuccessMessage.vue';
import {
  passwordValidation,
