...
export class PaymentService {
    ...
    async create(createPaymentDto: CreatePaymentDto): Promise<Payment> {
        ...
        this.logger.debug("debug", "createPayment : new payment for quote ID " + createPaymentDto.quote_id + ", €" + createPaymentDto.price);
    ...
    async getSession(title, tarif, token, insurance_id) {
        this.logger.debug("debug", "Payement getSession : new payment session for insurance ID " + insurance_id);
